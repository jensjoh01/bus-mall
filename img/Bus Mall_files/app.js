...
function displayImages() {
  ...
  while (number[1] === number[0] || number[1] === Image.previousNumber[1] || number[1] === Image.previousNumber[2] || number[1] === Image.previousNumber[2]){
    number[1] = makeRandomNumber();
  }
  number[2] = makeRandomNumber();
  while (number[2] === number[0] || number[2] === number[1] || number[2] === Image.previousNumber[1] || number[2] === Image.previousNumber[2] || number[2] === Image.previousNumber[2]) {
    number[2] = makeRandomNumber();
  }
